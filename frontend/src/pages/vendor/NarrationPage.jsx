...
export default function NarrationPage() {
  ...
  useEffect(() => {
    narrationService.getByBoothId(boothId)
      ...
      .catch(() => showToastRef.current('Không thể tải nội dung thuyết minh.', 'error'))
  ...
  return (
    <Layout>
      <div className={styles.container}>
        ...
        <h1 className={styles.title}>✏️ Nội dung thuyết minh gian hàng</h1>
        <p className={styles.subtitle}>
          Nhập nội dung tiếng Việt để hệ thống dịch đa ngôn ngữ bằng AI.
        </p>
        ...
        <div className={styles.card}>
          ...
          <div className={styles.btnGroup}>
            ...
            >
              {translating ? 'Đang dịch...' : '🤖 Dịch tự động với AI'}
            </button>
          </div>
        </div>

        <h2 className={styles.sectionTitle}>Trạng thái bản dịch</h2>
