...
namespace backend.Services
{
    public class NarrationService
    {
        ...
        public NarrationService(INarrationRepository repo)
        {
            _repo = repo;
        }
        ...
        public async Task<NarrationResponse> GetByBoothIdAsync(int boothId)
        {
            ...
            if (narration == null)
                throw new KeyNotFoundException($"Không tìm thấy narration cho booth {boothId}");
        ...
        private static NarrationResponse MapToResponse(Narration n) => new NarrationResponse
        {
            Id = n.Id,
            BoothId = n.BoothId,
            Title = n.Title,
